        ...
        <div className='d-flex flex-column' style={{ height: "100%" }}>
          ...
          <div className='d-flex flex-column justify-content-between' style={{ height: "100%" }}>
            <span className='d-flex flex-column mt-4'>
              ...
              <button className={`${ (tab === 'upload') ? 'active' : '' } nav-butt border-b border-gray-300 py-[10px] flex justify-content-center align-items-center gap-x-3`} onClick={() => handleTabChange('upload')}>{t('upload')}</button>
              <button className={`${ (tab === 'create-quiz') ? 'active' : '' } nav-butt border-gray-300 py-[10px] flex justify-content-center align-items-center gap-x-3`} onClick={() => handleTabChange('create-quiz')}>{t('createquiz')}</button>
            </span>
